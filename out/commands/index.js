...
const registerCommands = (context) => {
    // 初始化工作区
    const initWorkspaceCmd = vscode.commands.registerCommand('novel-helper.initWorkspace', initWorkspace_1.initWorkspace);
    context.subscriptions.push(initWorkspaceCmd);
    // 创建小说项
    const createItemCmd = vscode.commands.registerCommand('novel-helper.createItem', (type, parentPath) => {
